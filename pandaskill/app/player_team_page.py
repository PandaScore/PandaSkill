...
def display_player_team_page(data):
    ...
    start_date, end_date = select_date_range(ratings)
    ...
    comparing_entities = ratings['entity_name'].nunique() > 1

    display_player_evolution(ratings, comparing_entities)

def select_date_range(skill_ratings):

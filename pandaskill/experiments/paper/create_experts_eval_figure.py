...
models = {
    ("pscore_test", "ewma"): "PScore +\nEWMA",
    ("pscore_test", "openskill") : "PScore +\nOpenSkill",
    ("pscore_test", "meta_openskill") : "PScore +\nMeta_OpenSkill",
    ("pscore_test", "ffa_openskill") : "PScore +\nFFA_OpenSkill",
    ("pscore_test", "meta_ffa_openskill") : "PScore +\nMeta_FFA_OpenSkill",
    ("pscore_test", "meta_ffa_trueskill") : "PScore +\nMeta_FFA_TrueSkill",
    ("playerank_test", "ewma"): "PlayeRank+\nEWMA",
    ("playerank_test", "meta_ffa_openskill"): "PlayeRank +\nMeta_FFA_OpenSkill",
    ("performance_index_test", "ewma"): "PI +\nEWMA",
    ("performance_index_test", "meta_ffa_openskill"): "PI +\nMeta_FFA_OpenSkill",    
}

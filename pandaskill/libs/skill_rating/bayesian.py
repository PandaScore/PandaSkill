...
def _compute_overall_skill_ratings(
    ...
    overall_mu, overall_sigma = combine_contextual_and_meta_ratings(
       contextual_rating["mu"], contextual_rating["sigma"] ,
       meta_rating["mu"], meta_rating["sigma"] 
    )
    overall_lower_bound = lower_bound_rating(overall_mu, overall_sigma)
    return {
        "mu": overall_mu,
        "sigma": overall_sigma,
        "lower_bound": overall_lower_bound
    }
